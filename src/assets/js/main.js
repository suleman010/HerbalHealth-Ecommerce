/*-----------------------------------------------------------------------------------
    Template Name: Cannaweed Cannabis Consulting & Shop html template
    Template URI: https://metropolitanthemes.com/themes/html/onitir
    Author: WebTend
    Author URI: https://metropolitanthemes.com
    Version: 1.0
...
/*---------------------------
    ...
    13. Clinet Carousel
    14. cannafolio Gird
    15. cannafolio Masonry
    16. cannafolio Slider
...
(function ($) {
	...
	onitirDoc = {
		init: function () {
			...
			this.DetailSlider();
			this.cannafolioGird();
			this.cannafolioMasonry();
			this.cannafolioSlider();
			this.Rangeslider();
			this.bootstrapAcc();
			this.sliderTwo();
			this.offCanvasMenu();
